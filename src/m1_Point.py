...
# ----------------------------------------------------------------------
class Point(object):
    """Represent 2D point in x y space."""
    ...
    def move_to(self, x, y):
        new_point = Point(x, y)
        self.distace_traveled += self.get_distance_from(new_point)
        self.x = x
        self.y = y
        self.moves += 1
    ...
    def move_by(self, dx, dy):
        ...
        self.y += dy
        self.moves += 1
        self.distace_traveled += math.sqrt(dx**2 + dy**2)
    ...
    def get_distance_from_start(self):
        point_start = Point(self.intx, self.inty)
        return self.get_distance_from(point_start)

    def get_distance_traveled(self):
        return self.distace_traveled
